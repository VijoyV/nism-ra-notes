...
Industry analysis acts as the critical bridge between macro-economic analysis and individual company research. While economic analysis determines if the overall environment is growing, industry analysis identifies which specific sectors will thrive or struggle within that environment.
...
## 6.2 Defining the Industry and Sectors
Defining an industry is challenging because standard classification systems like the **National Industry Classification (NIC)** or **Global Industry Classification Standard (GICS)** may not capture the competitive substance of a business.

| Term | Scope | Example |
| :--- | :--- | :--- |
| **Economic Sector** | Broad segments of the national income. | Agriculture, Manufacturing, Services. |
| **Business Sector** | A broad category of related industries. | Financial Services (includes Banking, Insurance, etc.). |
| **Industry** | Firms offering similar products to serve the same need. | Auto Industry, Steel Industry. |

**The Definition Challenge:**
Analysts must look beyond product types to **customer needs**. For example, **PVR Limited** can be defined narrowly as a "Cinema Exhibitor" or broadly as "Out of Home (OOH) Entertainment," which includes live theater and sporting leagues. Similarly, the camera industry was disrupted because it failed to recognize competition from mobile phones.

---

## 6.3 Understanding Industry Cyclicality
Industries are categorized by their "income elasticity," or how much demand changes when consumer income rises or falls.

1.  **Defensive Industries:** Products with low income elasticity. Demand remains stable regardless of the economy (e.g., **Healthcare, Food, Agricultural inputs**).
2.  **Semi-Cyclical Industries:** Experience growth during booms and decline during recessions but maintain a "base level" of demand (e.g., **Consumer Durables**).
3.  **Deep Cyclical Industries:** Highly sensitive to economic and commodity cycles. They suffer during recessions but see massive growth during recovery due to pent-up demand (e.g., **Capital Goods, Steel**).
...
## 6.5 Secular Trends and Value Migration
...
## 6.6 Frameworks for Industry Landscaping

### I. Michael Porter’s Five Force Model
This model determines an industry's attractiveness and long-term profitability.

| Force | Impact on Profitability |
| :--- | :--- |
| **Industry Rivalry** | High rivalry (many players, standard products) leads to lower pricing power. |
| **Threat of Substitutes** | High if switching costs are low (e.g., SMS replacing Telegrams). |
| **Bargaining Power of Buyers** | High if there are many sellers and few buyers (e.g., Government as a buyer). |
| **Bargaining Power of Suppliers** | High if the input is critical or controlled by a few (e.g., OPEC for Crude Oil). |
| **Barriers to Entry (Moat)** | High barriers (licensing, high capital, strong brands) protect profits. |
...
## 6.7 Key Industry Drivers and KPIs

| Industry | Key Performance Indicators (KPIs) |
| :--- | :--- |
| **Airlines/Logistics** | Passenger/Cargo km, Occupancy rate, Price per km. |
| **Banking/NBFC** | **NIM** (Net Interest Margin), **NPA** Ratio, **CASA** Ratio, Capital Adequacy. |
| **IT Services** | **FTE** (Full Time Equivalent) billing, Attrition rate, Revenue per FTE. |
| **Retail** | Number of stores, **Same-Store Sales Growth** (SSSG). |
| **Telecom** | **ARPU** (Average Revenue Per User), Subscriber Churn rate. |
