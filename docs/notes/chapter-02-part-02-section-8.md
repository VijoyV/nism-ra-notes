...
* One kilogram of 24-carat gold is essentially identical to another kilogram of 24-carat gold.
* A barrel of crude oil of a specified grade is interchangeable with another barrel of the same grade.
...
Therefore, two gold necklaces of identical weight may have completely different market values.
...
A sharp increase in crude oil prices can increase transportation costs, manufacturing costs, and inflation throughout the economy.
...
* Commodities and inflation are directly related → investing can help protect real value.
...
* Raw material prices often rise.
* Energy prices often rise.
* Precious metal prices may rise.

As a result, commodity investments may preserve purchasing power better than cash.

**Example**

Suppose inflation rises from 4% to 8%.
...
### Why Precious Metals Are Viable Investments?
...
investors often move toward gold.

For this reason gold is frequently called a **safe haven asset**.
...
Commodity ETFs allow investors to gain commodity exposure without physically owning the commodity.

The fund:

1. Collects money from investors.
2. Invests in commodities or commodity-linked instruments.
3. Issues ETF units to investors.
...
If gold prices rise by 10%:

* The ETF's NAV also rises approximately by the same amount.
...
Thus Gold ETFs provide a convenient way to invest in gold.
...
A futures contract is an agreement to buy or sell an asset at a specified future date and price.
...
Instead of directly buying commodities, professional managers invest in futures contracts.

The manager continuously adjusts positions based on:
...
Rather than purchasing physical oil, the manager purchases crude oil futures contracts.

If oil prices rise:

* Futures contracts gain value.
* Investors benefit.

This allows commodity exposure without physical ownership.
...
The warehouse issues a receipt confirming:
...
Ownership of the commodity changes without physically moving the goods.
...
Instead of physically transporting wheat to a buyer:

1. The warehouse receipt is transferred.
2. Ownership changes.
3. The wheat remains in the same warehouse.

This reduces transportation and handling costs.

---

## Importance in Commodity Markets

Warehouse receipts:

* Facilitate commodity financing
* Improve market liquidity
* Reduce transaction costs
* Support commodity exchanges
* Enable efficient transfer of ownership
...
| Aspect               | Commodities      | Financial Securities     |
| -------------------- | ---------------- | ------------------------ |
| Nature               | Physical assets  | Financial claims         |
| Examples             | Gold, Oil, Wheat | Shares, Bonds            |
| Income Generation    | Usually none     | Dividends/Interest       |
| Storage Requirement  | Often required   | Not required             |
| Inflation Protection | Generally strong | Depends on security type |
| Physical Utility     | Yes              | No                       |
