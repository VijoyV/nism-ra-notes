...
| Type of Analyst | Primary Employer | Purpose of Research | Target Audience |
| :--- | :--- | :--- | :--- |
| **Sell-side Analyst** | Broking firms, Investment Banks | Publish reports with specific recommendations (Buy/Hold/Sell) and price targets. | Public domain/Clients of the firm. |
| **Buy-side Analyst** | Asset Managers (Mutual Funds, Hedge Funds, Pension Funds) | Generate internal investment recommendations for fund managers. | Internal consumption only; not available to the public. |
| **Independent Analyst** | Boutique research firms | Provide customized research or subscription-based reports. | Institutions, regulators, and individual subscribers. |
...
| :--- | :--- | :--- |
| **Qualitative** | Intangible factors that provide a competitive edge. | Management capabilities, brand power, business model strengths, and work ethics. |
| **Quantitative** | Performance metrics captured as numerical data. | Revenues, costs, profitability, assets/liabilities, and capacity utilization. |
